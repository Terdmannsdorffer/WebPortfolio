...
1. **CV** — copy your CV PDF into the root folder and name it exactly `cv.pdf`. Delete `cv.pdf.PLACEHOLDER.txt`.
   ...
   ```
2. **GitHub links** in the journey section currently all point at your profile root. Once you have specific repos for your thesis project, Turbo Files, etc., update them.
